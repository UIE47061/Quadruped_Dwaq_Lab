...
"""
GO2 DWAQ Environment - Blind Walking with Variational Autoencoder

This environment implements DWAQ (Deep Variational Autoencoder for Walking) training
for the GO2 robot. It follows the Isaac Lab interface style where step() returns
...
from legged_lab.envs.little_white.little_white_dwaq_config import LittleWhiteDwaqEnvCfg

from legged_lab.utils.env_utils.scene import SceneCfg
from rsl_rl.env import VecEnv


class LittleWhiteDwaqEnv(VecEnv):
    """
    GO2 DWAQ environment for blind walking with β-VAE.
    ...
    def __init__(
        self,
        cfg: LittleWhiteDwaqEnvCfg,
        headless: bool,
    ):
        self.cfg: LittleWhiteDwaqEnvCfg
    ...
    def compute_current_observations(self):
        ...
        # Build critic obs with privileged information (same as go2_rgb_env)
