...
"""
BigRedDog DWAQ Environment Configuration
...
sets up the BigRedDog robot for DWAQ-based training.
"""
...
from legged_lab.assets.unitree import BIGREDDOG_CFG
...
@configclass
class BigRedDogDwaqRewardCfg(RewardCfg):
    """Reward configuration for BigRedDog DWAQ blind walking."""
...
@configclass
class BigRedDogDwaqEnvCfg(BaseEnvCfg):
    """BigRedDog DWAQ environment configuration for blind walking with VAE."""
    
    reward = BigRedDogDwaqRewardCfg()
    ...
    def __post_init__(self):
        ...
        self.scene.robot = BIGREDDOG_CFG
        ...
        self.noise.noise_scales.ang_vel = 1.5
        self.noise.noise_scales.projected_gravity = 0.4
        self.noise.noise_scales.joint_pos = 0.05
...
@configclass  
class BigRedDogDwaqAgentCfg(BaseAgentCfg):
    """BigRedDog DWAQ agent configuration."""
    experiment_name: str = "bigreddog_dwaq"
    wandb_project: str = "bigreddog_dwaq"
